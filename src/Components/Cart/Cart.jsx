        ...
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          ...
          <TableBody className='tableBody'>
            {cart.map((row) => (
              ...
              <div className='gridBeginning'> <div className='gridImage'><img className='imageCart' src={row.imagen} alt=""/></div> <p className='gridName'>{row.nombre}</p> </div>  
                </TableCell>
                ...
                <TableCell aling="left"> <div className='flexCart'><div className='priceCart'>€ {row.quantity * row.precio}.00</div><div className='cleanCart' onClick={() =>{ removeItem(row.id)}} ><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-x-lg" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M13.854 2.146a.5.5 0 0 1 0 .708l-11 11a.5.5 0 0 1-.708-.708l11-11a.5.5 0 0 1 .708 0Z"/><path fill-rule="evenodd" d="M2.146 2.146a.5.5 0 0 0 0 .708l11 11a.5.5 0 0 0 .708-.708l-11-11a.5.5 0 0 0-.708 0Z"/></svg></div></div> </TableCell>
              </TableRow>
            ))}
              <TableRow className='paddingCart'>
              <TableCell sx={{ minWidth: 10 }} align='left' colSpan={2}><p className='totalCart'>Total</p></TableCell>
              <TableCell align="left"> <p className='priceCart'>€ {price}.00</p> </TableCell>
              <TableCell align="left"> <div className='gridAdd'> <div className='checkoutCart'><Link to={"/checkout"}> <button className='buttonCart'>Terminar Compra</button> </Link></div> <div className='buttonAdd'> <Link to={"/ItemListContainer"}><button className='buttonCart'>Añadir mas productos</button></Link></div><div className='deleteCart' onClick={() =>{ clear()}}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-trash3" viewBox="0 0 16 16"><path d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5ZM11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H2.506a.58.58 0 0 0-.01 0H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1h-.995a.59.59 0 0 0-.01 0H11Zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5h9.916Zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47ZM8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5Z"/></svg></div> </div> </TableCell>
            </TableRow>
          </TableBody>
        </Table>
      </TableContainer>
