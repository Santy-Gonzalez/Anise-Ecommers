    ...
    <>
     <div className='gridContact'>
         ...
         <div className='contactWith'>
             <p className='nova'>Para cualquier consulta de clientes o de ventas, contacta con:</p>
         </div>

         <div className='CustomerSupport'>
             <p className='nova'>Atención al cliente</p>
             <div className='anchor'>
               <p>correoelectrónico@ejemplo.com</p>
             </div>
         </div>
         <div className='wholesaler'>
             <p className='nova'>Consultas por ventas mayoristas</p>
             <div className='anchor'>
             <p>correoelectrónico@ejemplo.com</p>
             </div>
         </div>
         <div className='press'>
             <p className='nova'>Consultas de prensa</p>
             <div className='anchor'>
             <p>correoelectrónico@ejemplo.com</p>
             </div>
         </div>
